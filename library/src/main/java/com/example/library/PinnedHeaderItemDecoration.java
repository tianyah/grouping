...
import com.example.library.callback.OnHeaderClickListener;
import com.example.library.callback.OnItemTouchListener;
import com.example.library.utils.DividerHelper;
...
public class PinnedHeaderItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public interface OnHeaderisShowImageLister{
        void isShow(View view, int position);
    }
    ...
    private void createPinnedHeader(final RecyclerView parent) {
        ...
        if (pinnedHeaderPosition >= 0 && mPinnedHeaderPosition != pinnedHeaderPosition) {
            ...
            if (mHeaderClickListener != null) {
                    if (mOnisShowImageListener!=null) {
                        mOnisShowImageListener.isShow(mPinnedHeaderView, mPinnedHeaderPosition - mDataPositionOffset);
                }
    ...
    public void setOnisShowImage(OnHeaderisShowImageLister mOnisShowImageListener){
        this.mOnisShowImageListener = mOnisShowImageListener;
    }
    ...
    public static class Builder {
        ...
        private OnHeaderisShowImageLister headerisShowImageLister;
        ...
        public Builder setHeaderImageListener(OnHeaderisShowImageLister headerClickListener) {
            this.headerisShowImageLister = headerClickListener;
            return this;
        }
